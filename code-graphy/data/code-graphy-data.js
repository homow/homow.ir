const codeGraphyData = [
    ...
    },
    {
        ...
        title: "و در آخر",
        text: [
            "این <a href='/' class='link-hover-style' target='_blank'>«وبسایت»</a> شاید برای شما فقط یه سایت باشه، ولی برای من، توی روزهای سخت، مثل یه پناهگاه بود. یه جایی که توش کد زدم، نفس کشیدم، و خودم بودم.",
