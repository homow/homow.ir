...
<div class="footer__info-wrapper">
            ...
            <div class="footer-container">
                <div class="footer__about">
                    <h3>درباره من</h3>
                    <p>همایون شریفی، توسعه‌دهنده وب با تمرکز روی معماری سیستم‌های مدرن و طراحی دقیق. این وبسایت نمونه‌ای از کار من در ساختاردهی و پیاده‌سازی پروژه‌های واقعی است.</p>
                </div>
