const codeGraphyData = [
    ...
    },
    {
        ...
        text: [
            ...
            "من یک <a href='/404.html' class='link-hover-style' target='_blank'>«صفحه 404»</a> هم طراحی کردم که شاید گذرتون بهش نخوره، پس لینکش رو همینجا گذاشتم"
        ],
        imgData: [
    ...
    },
    {
        ...
        title: "و در آخر",
        text: [
            "این <a href='https://copilot.microsoft.com/' class='link-hover-style' target='_blank'>«وبسایت»</a> شاید برای شما فقط یه سایت باشه، ولی برای من، توی روزهای سخت، مثل یه پناهگاه بود. یه جایی که توش کد زدم، نفس کشیدم، و خودم بودم.",
            "با اینکه دوستش دارم، ولی مطمئنم هنوز جا برای بهتر شدن داره، اگه نظری یا انتقادی داشتی حتماً برام تو فرم زیر بنویس، پیام تک تکون رو می‌خونم و جدی می‌گیرم."
        ],
        imgData: [
            "/asset/img/about-site/my-home.png",
        ],
        textSub: "منتظر نقد ها و نظراتت هستم"
    }
]
